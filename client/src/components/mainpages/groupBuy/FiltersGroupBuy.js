...
const FiltersGroupBuy = () => {
    const state = useContext(GlobalState)
    const [categories] = state.categoriesAPI.categories
    // const [brands] = state.brandsAPI.brands
    const [productTypes] = state.productTypesAPI.productTypes

    const [category, setCategory] = state.groupBuysAPI.category
    // const [brand, setBrand] = state.productsAPI.brand
    const [productType, setProductType] = state.groupBuysAPI.productType
    // const [sort, setSort] = state.productsAPI.sort
    const [search, setSearch] = state.groupBuysAPI.search
...
export default FiltersGroupBuy;