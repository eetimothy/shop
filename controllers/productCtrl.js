...
const productCtrl = {
    ...
    createProduct: async (req, res) => {
        try {
            const { 
                product_id, title, groupBuyPrice, buyNowPrice, description, 
                content, images, brand, category, productType, 
                vendorId, vendorCompany, vendorEmail, vendorUsername, 
                vendorMobile, groupBuyQty, totalQty, isActive, maxGroupBuys, successTarget 
            } = req.body;
            ...
            const newProduct = new Products({
                product_id, title: title.toLowerCase(), groupBuyPrice, buyNowPrice, description, content, images, brand, productType, category, vendorId, vendorCompany, vendorEmail, vendorUsername, vendorMobile, groupBuyQty, totalQty, isActive, maxGroupBuys, successTarget
            })
